...
TEST(BasicConceptsTest, LambdaAndFunctorTraits)
{
  ...
  using ConstFunctorTraits2 = function_traits<decltype(func1)>;
...
TEST(BasicConceptsTest, ReferenceQualifiedMemberFunctionTraits)
{
  ...
  //// 测试 volatile + 引用限定符
  //{
  //  using VolatileLvalueTraits = function_traits<decltype(&RefQualifiedMethods::volatileLvalueMethod)>;
  ...
  //  using VolatileRvalueTraits = function_traits<decltype(&RefQualifiedMethods::volatileRvalueMethod)>;
  ...
  //{
  //  using ConstVolatileLvalueTraits = function_traits<decltype(&RefQualifiedMethods::constVolatileLvalueMethod)>;
  ...
  //  using ConstVolatileRvalueTraits = function_traits<decltype(&RefQualifiedMethods::constVolatileRvalueMethod)>;
  ...
  //// 测试可变参数 + 引用限定符
  //{
  //  using VariadicLvalueTraits = function_traits<decltype(&RefQualifiedMethods::variadicLvalueMethod)>;
  ...
  //  using VariadicRvalueTraits = function_traits<decltype(&RefQualifiedMethods::variadicRvalueMethod)>;
  ...
  //// 测试 const + 可变参数 + 引用限定符
  //{
  //  using ConstVariadicLvalueTraits = function_traits<decltype(&RefQualifiedMethods::constVariadicLvalueMethod)>;
  ...
  //  using ConstVariadicRvalueTraits = function_traits<decltype(&RefQualifiedMethods::constVariadicRvalueMethod)>;
  ...
  //{
  //  using VolatileVariadicLvalueTraits = function_traits<decltype(&RefQualifiedMethods::volatileVariadicLvalueMethod)>;
  //  EXPECT_TRUE((std::is_same_v<VolatileVariadicLvalueTraits::result_type, void>));
  //  EXPECT_TRUE((std::is_same_v<VolatileVariadicLvalueTraits::args_tuple, std::tuple<const char*>>));
  ...
  //  using VolatileVariadicRvalueTraits = function_traits<decltype(&RefQualifiedMethods::volatileVariadicRvalueMethod)>;
  //  EXPECT_TRUE((std::is_same_v<VolatileVariadicRvalueTraits::result_type, void>));
  //  EXPECT_TRUE((std::is_same_v<VolatileVariadicRvalueTraits::args_tuple, std::tuple<const char*>>));
  ...
  //{
  //  using ConstVolatileVariadicLvalueTraits = function_traits<decltype(&RefQualifiedMethods::constVolatileVariadicLvalueMethod)>;
  //  EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicLvalueTraits::result_type, void>));
  //  EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicLvalueTraits::args_tuple, std::tuple<const char*>>));
  //  EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicLvalueTraits::class_type, RefQualifiedMethods>));
  //  EXPECT_EQ(ConstVolatileVariadicLvalueTraits::arity, 1);
  //  EXPECT_TRUE(ConstVolatileVariadicLvalueTraits::is_variadic);

  //  using ConstVolatileVariadicRvalueTraits = function_traits<decltype(&RefQualifiedMethods::constVolatileVariadicRvalueMethod)>;
  //  EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicRvalueTraits::result_type, void>));
  //  EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicRvalueTraits::args_tuple, std::tuple<const char*>>));
  //  EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicRvalueTraits::class_type, RefQualifiedMethods>));
...
TEST(BasicConceptsTest, QualifiedMemberFunctionTraits)
{
  ...
  //// const volatile 方法
  //using ConstVolatileMethodTraits = function_traits<decltype(&QualifiedMethods::constVolatileMethod)>;
  ...
  //// volatile 可变参数方法
  //using VolatileVariadicMethodTraits = function_traits<decltype(&QualifiedMethods::variadicVolatileMethod)>;
  //EXPECT_TRUE((std::is_same_v<VolatileVariadicMethodTraits::result_type, void>));
  //EXPECT_TRUE((std::is_same_v<VolatileVariadicMethodTraits::args_tuple, std::tuple<const char*>>));
  ...
  //using ConstVolatileVariadicMethodTraits = function_traits<decltype(&QualifiedMethods::variadicConstVolatileMethod)>;
  //EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicMethodTraits::result_type, void>));
  //EXPECT_TRUE((std::is_same_v<ConstVolatileVariadicMethodTraits::args_tuple, std::tuple<const char*>>));
